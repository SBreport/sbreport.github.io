...
- 핵심 제약 둘: (1) 한 후기를 칭찬어만으로 길게 늘리지 마라. 짧으면 단순 칭찬 한두 마디로 끝내도 좋다(실제 후기 다수가 그렇다). 길게 쓸 거면 반드시 겪은 구체 하나를 담아라 — 결과·변화(며칠 뒤 어땠는지), 몸의 느낌, 가격·예약·주차 같은 디테일. (2) 여러 샘플이 같은 칭찬 표현·감탄 패턴을 복붙하듯 똑같이 반복하지 마라(배치 다양성).
