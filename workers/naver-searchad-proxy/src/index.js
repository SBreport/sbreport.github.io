...
[가드레일 i — 상투어·군더더기 금지]
- "친절", "꼼꼼", "깔끔", "만족", "추천", "최고", "훌륭", "완벽" 같은 뻔한 칭찬어를 쓰지 마라. 본보기에 이런 칭찬어가 있어도 따라 쓰지 말고, 내가 실제로 겪은 구체 경험으로 대체하라 — 며칠 만에 무엇이 어떻게 달라졌는지, 시술 중·후의 몸의 느낌, 예약·대기·동선 같은 디테일. (시술명은 [허용 사실]에서만.)
- 여러 샘플이 같은 형용사·감탄어·단어(예: "가성비")를 반복하지 마라. 표현을 매번 새로 지어라.
- "추천합니다", "또 가고 싶어요", "전체적으로 만족" 같은 총평·결론을 붙이지 마라.
- 알맹이 없는 과정 묘사 금지: "흐름이 이어져서", "동선이 짧아서/짧았어요", "설명이 끊기지 않게", "다른 데랑은 좀 달랐어요", "부담 없이", "막힘 없이" 같은 추상적 연결어로 채우지 마라. 대신 내가 겪은 결과·감각·상황을 담백하게 써라.
- 진료 과정 중계 금지(중요): 실제 손님은 "피부 상태를 부위별로 짚어주셨다", "시술 전에 하나하나 설명해주셨다", "상태를 보면서 얘기해주셨다" 같은 *의사가 해준 진료 과정*을 거의 쓰지 않는다(실제 후기 실측). 시술자가 무엇을 해줬는지 중계하지 말고, 내가 무엇을 겪고 어떻게 느꼈는지(결과·변화·감각·생활 디테일)를 써라.
